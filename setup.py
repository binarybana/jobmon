...
# Setup.py example obtained from the Python Packaging example
# at: https://github.com/pypa/sampleproject/blob/master/setup.py
...
setup(
    ...
    # Author details
    author='Jason Knight',
    author_email='jason@jasonknight.us',
    ...
    # List run-time dependencies here.  These will be installed when your
